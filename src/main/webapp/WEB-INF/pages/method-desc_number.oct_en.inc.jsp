...
%><h3>About octal numbers</h3>
<p>Eighth numbers represent numbers in octal notation.</p>

<p>In octadecimal numbers, the number is represented by "01234567" with 8 as the base.</p>

<p>An example of conversion in 8 base is as follows. For reference, an example of conversion between binary and hexadecimal numbers is also provided.</p>
...
<p>Also, numbers after the decimal point are converted as 8<sup>-1</sup> (1/8), 8<sup>-2</sup> (1/64), 8<sup>-3</sup> (1/512), ... in hexadecimal numbers. If the number after the decimal point cannot be represented by the total of 8<sup>-n</sup>, it cannot be completely converted to hexadecimal and an error will occur. In that case, DenCode omits it by adding "..." at the end.</p>
