...
%><h3>8진수에 대해서</h3>
<p>8진수는 수치를 8진 기수법으로 표현합니다.</p>

<p>8진수에서는 수치를 8을 밑으로 하여 '01234567'로 나타냅니다.</p>

<p>8진수 변환 예는 다음과 같습니다. 참고로 2진수와 16진수 변환 예도 기재하고 있습니다.</p>
...
<p>또한 소수점 이하의 수치는 8진수에서는 8<sup>-1</sup> (1/8), 8<sup>-2</sup> (1/64), 8<sup>-3</sup> (1/512), ... 의 각 자릿수 값으로서 변환합니다. 소수점 이하의 수치가 8<sup>-n</sup>의 합계로 나타낼 수 없는 경우는, 완전하게는 8진수로 변환할 수 없어 오차가 발생합니다. 그 경우 DenCode에서는 끝에 "..."을 붙임으로써 생략하여 나타냅니다.</p>
