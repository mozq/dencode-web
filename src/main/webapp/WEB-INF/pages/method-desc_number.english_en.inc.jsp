...
<h4>Large Numbers</h4>
<p>For larger numbers, the digits are short scale or long scale and are expressed as follows: The name of the digit changes by 3 digits on the short scale and by 6 digits on the long scale. The long scale also has the Chuquet system, which represents digits of 10<sup>6N+3</sup> as "Thousand -illion", and the Peletier system, which represents "-illiard".</p>
<p>Short scale is mainly used in English-speaking countries such as the United States, Canada, and the United Kingdom (since 1974). In addition, the long scale Chuquet system was used in the United Kingdom before 1973, and the Peletier system is used in each language-specific notation in Europe, which is mainly non-English speaking countries such as France, Germany, and Italy.</p>
...
<div class="table-responsive">
	<table class="table table-sm table-fit">
		...
		<tbody>
			<tr><td>15</td><td>Quin<b>qua</b>decillion</td><td>Quindecillion</td><td>5 is "quinque", but 15 is more commonly "quindecim" than "quinquadecim".</td></tr>
			<tr><td>16</td><td>Sedecillion</td><td>Se<b>x</b>decillion</td><td>"Sedecim" is more common than "sexdecim".</td></tr>
			<tr><td>19</td><td>Nove<b>n</b>decillion</td><td>Nove<b>m</b>decillion</td><td>Normally it is "undeviginti", but it may be written as "novendecim" or "novemdecim". A similar assimilation rule, N=17, is more commonly "septendecim" than "septemdecim".</td></tr>
		</tbody>
	</table>
</div>

<p>The "quinqua" for 5 is "quinque" in Latin, but 15 is "quindecim" in Latin and "quindecillion" in English. Therefore, only "quinqua" in the Conway-Wechsler system may be replaced with "quin". This replacement was presented by Olivier Miakinen (See：<cite><a href="http://www.miakinen.net/vrac/zillions" target="_blank">Olivier Miakinen. Les zillions selon Conway, Wechsler... et Miakinen, 2003</a></cite> (French web page)). DenCode also uses "quin", which is closer to the name of the English dictionary.</p>
...
<p>"Tre <sup>(s(x))</sup>", "se <sup>(sx)</sup>", "septe <sup>(mn)</sup>", and "nove <sup>(mn)</sup>" of the Conway-Wechsler system are fixed at "tre", "se<b>x</b>", "septe<b>n</b>", and "nove<b>m</b>" on the CW4EN system. Only when N=103 is "Tre<b>s</b>centillion" instead of "Trecentillion". This is to avoid duplication with "Trecentillion" with N=300.</p>
<p>There are examples of adopting systems similar to the CW4EN system, but they do not take into account or mention the difference between "Tre<b>s</b>centillion" / "Trecentillion". (e.g. <cite><a href="https://www.nasdaq.com/glossary" target="_blank">Glossary of Stock Market Terms &amp; Definitions | Nasdaq</a></cite>)</p>
