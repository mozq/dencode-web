...
%><h3>關於 ROT18</h3>
<p>ROT18 是一種透過替換文本中的字元來進行加密的單表代換密碼。</p>
<p>字元的替換是透過將「A」到「Z」的字元在「ABCDEFGHIJKLMNOPQRSTUVWXYZ」這 26 個字元中移動 13 個位置來進行的。而數字「0」到「9」則在「0123456789」這 10 個字元中移動 5 個位置。</p>
