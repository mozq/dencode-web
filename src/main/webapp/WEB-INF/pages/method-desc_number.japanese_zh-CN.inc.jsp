...
%><h3>关于日语汉字数字 (Japanese Numerals)</h3>
<p>用日语的汉字数字表示数值。汉字数字有两种：一种是现代日本使用的，另一种是称为大写数字（大字）的旧字体表示。</p>

<p>现代汉字数字和大写数字的示例如下。</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>阿拉伯数字</th><th>汉字数字</th><th>汉字数字 (大字)</th></tr>
		</thead>
		<tbody>
...
<p>10 以上的数字，各数位用以下汉字表示。在汉字数字中，每 4 位数位名称进位一次。这称为“万进”。</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>数位</th><th>汉字数字</th><th>汉字数字 (大字)</th></tr>
		</thead>
		<tbody>
...
<p>10, 100, 1000 通常省略“一”，写作“十”“百”“千”，而不是“一十”“一百”“一千”。但在大写数字中，有时会明确写出“壱”。</p>

<p>小数点以下在“・”之后用位值记数法表示。</p>

<p>在上述大写数字中，日本法律仅规定了“壱”“弐”“参”“拾”。</p>

<p>虽然大写数字中未定义“億”(10<sup>8</sup>) 以上的数位，但在 DenCode 中使用与普通汉字数字相同的数位名称表示。</p>
