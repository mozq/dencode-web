...
%><h3>À propos du chiffre de Vigenère</h3>
<p>Le chiffre de Vigenère est l'un des chiffres de substitution polyalphabétique qui chiffre en remplaçant les caractères du texte par d'autres caractères.</p>
<p>Le remplacement des caractères est effectué à l'aide de la clé de chiffrement et du carré de Vigenère suivant.</p>
...
<p>La ligne supérieure est le texte clair avant chiffrement, la colonne de gauche est la clé de chiffrement, et les caractères où ils se croisent sont les caractères après chiffrement. La clé de chiffrement est une chaîne de caractères de "A" à "Z".</p>
