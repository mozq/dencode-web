...
Depois da Criptografia: ZYXWVUTSRQPONMLKJIHGFEDCBA</pre>

<pre>Texto antes da Criptografia : THIS IS A SECRET MESSAGE
Texto depois da Criptografia: GSRH RH Z HVXIVG NVHHZTV</pre>

<p>Originalmente, era usada como uma cifra para o hebraico. A criptografia hebraica é a seguinte:</p>

<pre>Antes da Criptografia : אבגדהוזחטיכלמנסעפצקרשת
Depois da Criptografia: תשרקצפעסנמלכיטחזוהדגבא</pre>
...
Depois da Criptografia: ЯЮЭЬЫЪЩШЧЦХФУТСРПОНМЛКЙИЗЖЕДГВБА</pre>
...
Depois da Criptografia: ゔんをゑゐわゎろれるりらよょゆゅやゃもめむみまぽぼほぺべへぷぶふぴびひぱばはのねぬになどとでてづつっぢちだたぞそぜせずすじしざさごこげけぐくぎきがかおぉえぇうぅいぃあぁ</pre>

<pre>Antes da Criptografia : ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヰヱヲンヴ
Depois da Criptografia: ヴンヲヱヰワヮロレルリラヨョユュヤャモメムミマポボホペベヘプブフピビヒパバハノネヌニナドトデテヅツッヂチダタゾソゼセズスジシザサゴコゲケグクギキガカオォエェウゥイィアァ</pre>
