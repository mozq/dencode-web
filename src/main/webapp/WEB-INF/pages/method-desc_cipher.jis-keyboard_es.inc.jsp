...
%><h3>Sobre el Cifrado Teclado JIS</h3>
...
<p>El carácter Kana "を" (wo) no tiene correspondencia en el teclado JIS inglés, por lo que no se convierte.</p>

<p>Tenga en cuenta que "ー" se mapea excepcionalmente a "|". "\" (barra invertida o signo de yen) se mapea a "ろ".</p>

<p>Como opción, se proporcionan dos modos de conversión: modo estricto y modo indulgente. En el modo estricto, las letras mayúsculas y Katakana básicamente no se convierten, pero en el modo indulgente, también se convierten. Tenga en cuenta que en el modo indulgente, la reconversión puede no devolver el carácter original, como "N -&gt; み -&gt; n" o "ミ -&gt; n -&gt; み".</p>
