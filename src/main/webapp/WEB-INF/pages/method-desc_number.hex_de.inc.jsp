...
%><h3>Über Hexadezimalzahlen</h3>
<p>Hexadezimalzahlen stellen numerische Werte im Basis-16-System dar.</p>

<p>Im Hexadezimalsystem werden Zahlen zur Basis 16 mit den Ziffern „0123456789ABCDEF“ dargestellt. Die Dezimalzahlen 0 bis 9 entsprechen 0 bis 9, und 10 bis 15 werden durch A bis F dargestellt.</p>

<p>Beispiele für die Umrechnung in Hexadezimalzahlen sind unten aufgeführt. Als Referenz sind auch Binär- und Oktalzahlen angegeben.</p>
...
<p>Nachkommastellen werden im Hexadezimalsystem als Summe von 16<sup>-1</sup> (1/16), 16<sup>-2</sup> (1/256), 16<sup>-3</sup> (1/4096), ... dargestellt. Wenn eine Dezimalzahl nicht exakt als Summe von Potenzen von 16<sup>-n</sup> dargestellt werden kann, tritt ein Konvertierungsfehler auf. In diesem Fall zeigt DenCode das Ergebnis verkürzt mit „...“ am Ende an.</p>
