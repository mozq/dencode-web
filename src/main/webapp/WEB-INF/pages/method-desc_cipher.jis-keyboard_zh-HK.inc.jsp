...
<p>JIS 鍵盤轉換 (Mikaka 轉換) 是一種單表替換密碼，透過用其他字元替換文字中的字元來加密。基本上，它用於日本互聯網上的行話和混淆。</p>
<p>字元替換是透過在日本 JIS 鍵盤 (JIS X4064 / OADG109A) 上列印的英文字元和日文字元之間進行轉換來執行的。最初，它源於稱為「みかか」(Mikaka) 的網絡俚語，這是用 JIS 鍵盤輸入日本電信營運商之一「<abbr title="Nippon Telegraph and Telephone corporation">NTT</abbr>」的結果。</p>
