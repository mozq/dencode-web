...
%><h3>Über Binärzahlen</h3>
<p>Binärzahlen (Dualsystem) stellen numerische Werte im Basis-2-System dar.</p>

<p>Im Binärsystem werden Zahlen zur Basis 2 mit den Ziffern „0“ und „1“ dargestellt.</p>

<p>Beispiele für die Umrechnung in Binärzahlen sind unten aufgeführt. Als Referenz sind auch Oktal- und Hexadezimalzahlen angegeben.</p>
...
<p>Nachkommastellen werden im Binärsystem als Summe von 2<sup>-1</sup> (1/2), 2<sup>-2</sup> (1/4), 2<sup>-3</sup> (1/8), ... dargestellt. Wenn eine Dezimalzahl nicht exakt als Summe von Potenzen von 2<sup>-n</sup> dargestellt werden kann, tritt ein Konvertierungsfehler auf. In diesem Fall zeigt DenCode das Ergebnis verkürzt mit „...“ am Ende an.</p>
