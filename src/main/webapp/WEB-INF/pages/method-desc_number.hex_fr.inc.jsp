...
%><h3>À propos des nombres hexadécimaux</h3>
<p>Les nombres hexadécimaux représentent les valeurs numériques dans le système de numération hexadécimal.</p>

<p>En hexadécimal, les nombres sont représentés en base 16 avec "0123456789ABCDEF". Les nombres décimaux de 0 à 9 sont également représentés par 0 à 9 en hexadécimal, et 10 à 15 sont représentés par A à F.</p>

<p>Des exemples de conversion hexadécimale sont présentés ci-dessous. Pour référence, des exemples de conversion binaire et octale sont également inclus.</p>
...
<p>De plus, les nombres après la virgule sont convertis en hexadécimal comme valeurs de chaque position : 16<sup>-1</sup> (1/16), 16<sup>-2</sup> (1/256), 16<sup>-3</sup> (1/4096), ... Si la partie fractionnaire ne peut pas être représentée par la somme de 16<sup>-n</sup>, elle ne peut pas être convertie complètement en hexadécimal et une erreur se produit. Dans ce cas, DenCode l'exprime en ajoutant "..." à la fin pour indiquer l'omission.</p>
