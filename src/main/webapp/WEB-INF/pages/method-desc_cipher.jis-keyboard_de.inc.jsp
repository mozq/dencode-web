...
%><h3>Über die JIS-Tastatur-Chiffre</h3>
<p>Die JIS-Tastatur-Chiffre (Mikaka-Henkan) ist eine Substitution, die auf dem Layout japanischer Tastaturen basiert. Sie wird oft im japanischen Internet als Slang oder zur Obfuskation verwendet.</p>
<p>Die Substitution erfolgt durch den Austausch von englischen Zeichen mit den entsprechenden Kana-Zeichen auf einer japanischen JIS-Tastatur (JIS X4064 / OADG109A). Der Name "Mikaka" kommt daher, dass "NTT" auf einer solchen Tastatur als "Mikaka" getippt wird.</p>
...
<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Englisch</th><th>Kana</th></tr>
		</thead>
		<tbody>
...
<p>Das Kana-Zeichen "を" wird nicht konvertiert, da es keine direkte Entsprechung auf der Tastatur hat.</p>

<p>Beachten Sie, dass "ー" ausnahmsweise auf "|" abgebildet wird. "\" (Backslash oder Yen) wird auf "ろ" abgebildet.</p>

<p>Es gibt zwei Modi: Strikt und Tolerant. Der strikte Modus konvertiert keine Großbuchstaben oder Katakana. Der tolerante Modus konvertiert auch diese, ist aber nicht immer umkehrbar (z.B. kann "N" zu "み" werden, und "ミ" auch zu "n").</p>
