...
<p>Кроме того, числа после десятичной точки преобразуются как 2<sup>-1</sup> (1/2), 2<sup>-2</sup> (1/4), 2<sup>-3</sup> (1/8), ... в двоичном числа. Если число после десятичной точки не может быть представлено суммой 2<sup>-n</sup>, его невозможно полностью преобразовать в двоичном, и возникнет ошибка. В этом случае DenCode опускает его, добавляя "..." в конце.</p>
