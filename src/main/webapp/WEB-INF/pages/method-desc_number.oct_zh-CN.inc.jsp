...
%><h3>关于八进制 (Octal)</h3>
<p>八进制是用八进制记数法表示的数值。</p>

<p>在八进制中，数值以 8 为基数，用“01234567”表示。</p>

<p>八进制转换示例如下。作为参考，也列出了二进制和十六进制的转换示例。</p>
...
<p>此外，小数部分的数值在八进制中转换为 8<sup>-1</sup> (1/8), 8<sup>-2</sup> (1/64), 8<sup>-3</sup> (1/512), ... 各位的和。如果小数部分的数值无法用 8<sup>-n</sup> 的总和精确表示，则无法完全转换为八进制，会产生误差。在这种情况下，DenCode 会在末尾附加“...”表示省略。</p>
