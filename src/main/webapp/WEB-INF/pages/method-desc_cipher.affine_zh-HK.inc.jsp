...
<p>仿射密碼是一種透過替換文本中的字符來進行加密的單表代換密碼。</p>
<p>字符的替換透過以下公式進行。</p>

<pre>E(<var>x</var>) = (<var>a</var><var>x</var> + <var>b</var>) mod <var>m</var></pre>

<p><var>m</var> 表示要轉換的字符類型的數量。<var>x</var> 是將字符轉換為 0 到 m - 1 之間的數字。<var>a</var> 和 <var>b</var> 是加密金鑰。</p>
...
<p><var>a</var> 必須指定為與 <var>m</var> 互質的數值。這意味著 <var>a</var> 和 <var>m</var> 除了 1 以外沒有其他公因子。例如，當 <var>m</var> = 26 時，<var>a</var> = 4 是無效的，因為它除了 1 以外還能被 2 整除。在 DenCode 中，如果指定了無效的 <var>a</var>，將不進行轉換直接傳回原始字符。</p>
