...
<h4>Большие числа</h4>
<p>Для больших чисел цифры имеют короткую шкалу или длинную шкалу и выражаются следующим образом: Название цифры изменяется на 3 цифры на короткой шкале и на 6 цифр на длинной шкале. На длинной шкале также есть система Шюке, которая представляет цифры 10<sup>6N+3</sup> как «Thousand -illion», и систему Пелетье, которая представляет «-illiard».</p>
<p>Короткая шкала в основном используется в англоязычных странах, таких как США, Канада и Великобритания (с 1974 г.). Кроме того, до 1973 года в Соединенном Королевстве использовалась длинномасштабная система Chuquet, а Система Пелетье используется в обозначениях для каждого языка в Европе, а это в основном неанглоязычные страны, такие как Франция, Германия, и Италия.</p>
...
<div class="table-responsive">
	<table class="table">
		...
		<tbody>
			<tr><td>15</td><td>Quin<b>qua</b>decillion</td><td>Quindecillion</td><td>5 - это «quinque», но 15 чаще «quindecim», чем «quinquadecim».</td></tr>
			<tr><td>16</td><td>Sedecillion</td><td>Se<b>x</b>decillion</td><td>«Sedecim» встречается чаще, чем «sexdecim».</td></tr>
			<tr><td>19</td><td>Nove<b>n</b>decillion</td><td>Nove<b>m</b>decillion</td><td>Обычно это «undeviginti», но это может быть написано как «novendecim» или «novemdecim». Подобное правило ассимиляции, N = 17, чаще называется «septendecim», чем «septemdecim».</td></tr>
		</tbody>
	</table>
</div>

<p>«quinqua» для 5 - это «quinque» на латыни, но 15 - «quindecim» на латыни и «quindecillion» на английском языке. Следовательно, только «quinqua» в системе Конвея-Векслера может быть заменен на «quin». Эту замену представил Оливье Миакинен (см. <cite><a href="http://www.miakinen.net/vrac/zillions" target="_blank">Olivier Miakinen. Les zillions selon Conway, Wechsler... et Miakinen, 2003</a></cite> (французская веб-страница)). DenCode также использует «quin», что ближе к названию английского словаря.</p>
...
<p>«Tre <sup>(s(x))</sup>», «se <sup>(sx)</sup>», «septe <sup>(mn)</sup>» и «nove <sup>(mn)</sup>» системы Конвея-Векслера фиксируются на «tre», «se<b>x</b>», «septe<b>n</b>» и «nove<b>m</b>» в системе CW4EN. Только когда N=103 - это «Tre<b>s</b>centillion» вместо «Trecentillion». Это сделано для того, чтобы избежать дублирования с «Trecentillion» с N=300.</p>
<p>Существуют примеры внедрения систем, аналогичных системе CW4EN, но они не принимают во внимание и не упоминают разницу между «Tre<b>s</b>centillion» / «Trecentillion». (например. <cite><a href="https://www.nasdaq.com/glossary" target="_blank">Glossary of Stock Market Terms &amp; Definitions | Nasdaq</a></cite>)</p>
