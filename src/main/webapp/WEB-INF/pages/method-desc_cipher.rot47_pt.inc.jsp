...
<pre>Antes da Criptografia : !"#$%&amp;'()*+,-./0123456789:;&lt;=&gt;?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
Depois da Criptografia: PQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~!"#$%&amp;'()*+,-./0123456789:;&lt;=&gt;?@ABCDEFGHIJKLMNO</pre>

<pre>Texto antes da Criptografia : THIS IS A SECRET MESSAGE 123!
Texto depois da Criptografia: %wx$ x$ p $tr#t% |t$$pvt `abP</pre>
