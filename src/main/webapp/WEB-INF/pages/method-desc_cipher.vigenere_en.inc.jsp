...
<p>The top row is the plaintext before encryption, the left column is the encryption key, and the characters they intersect are the characters after encryption. The encryption key is a string from 'A' to 'Z'.</p>
