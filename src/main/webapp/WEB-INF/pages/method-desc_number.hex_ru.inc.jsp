...
%><h3>О шестнадцатеричных числах</h3>
<p>Шестнадцатеричный представляет числа в шестнадцатеричной системе счисления.</p>

<p>В шестнадцатеричном формате число представлено как «0123456789ABCDEF» с 16 в качестве основания. Десятичные числа от 0 до 9 представлены от 0 до 9 даже в шестнадцатеричных числах, а от 10 до 15 представлены от A до F.</p>

<p>Пример преобразования в шестнадцатеричный формат выглядит следующим образом. Для справки также предоставляется пример преобразования между двоичными и восьмеричными числами.</p>
...
<p>Кроме того, числа после десятичной точки преобразуются как 16<sup>-1</sup> (1/16), 16<sup>-2</sup> (1/256), 16<sup>-3</sup> (1/4096), ... в шестнадцатеричные числа. Если число после десятичной точки не может быть представлено суммой 16<sup>-n</sup>, его невозможно полностью преобразовать в шестнадцатеричное, и возникнет ошибка. В этом случае DenCode опускает его, добавляя "..." в конце.</p>
