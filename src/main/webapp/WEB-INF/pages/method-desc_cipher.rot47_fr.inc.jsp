...
<pre>Texte clair  : !"#$%&amp;'()*+,-./0123456789:;&lt;=&gt;?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
Texte chiffré: PQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~!"#$%&amp;'()*+,-./0123456789:;&lt;=&gt;?@ABCDEFGHIJKLMNO</pre>

<pre>Texte clair  : THIS IS A SECRET MESSAGE 123!
Texte chiffré: %wx$ x$ p $tr#t% |t$$pvt `abP</pre>
