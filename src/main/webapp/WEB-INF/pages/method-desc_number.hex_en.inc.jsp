...
%><h3>About hexadecimal numbers</h3>
<p>Hexadecimal represents numbers in hexadecimal notation.</p>

<p>In hexadecimal, the number is represented by "0123456789ABCDEF" with 16 as the base. Decimal numbers 0 to 9 are represented by 0 to 9 even in hexadecimal numbers, and 10 to 15 are represented by A to F.</p>
