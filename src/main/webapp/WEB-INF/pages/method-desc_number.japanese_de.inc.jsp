...
%><h3>Über Japanische Ziffern (Kansuuji)</h3>
<p>Stellt Zahlen als japanische Ziffern (Kanji) dar. Es gibt zwei Arten: die im modernen Japan gebräuchlichen und die sogenannten Daiji (Großbuchstaben), die in formalen oder rechtlichen Dokumenten verwendet werden.</p>

<p>Beispiele für moderne Kansuuji und Daiji:</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Arabisch</th><th>Kansuuji</th><th>Kansuuji (Daiji)</th></tr>
		</thead>
		<tbody>
...
<p>Für Zahlen ab 10 gibt es eigene Zeichen für die Zehnerpotenzen. Im Japanischen ändern sich die großen Einheiten alle 4 Ziffern (Potenzen von 10<sup>4</sup>).</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Größe</th><th>Kansuuji</th><th>Kansuuji (Daiji)</th></tr>
		</thead>
		<tbody>
