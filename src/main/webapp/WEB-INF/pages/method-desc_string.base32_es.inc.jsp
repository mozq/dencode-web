...
%><h3>Sobre Base32</h3>
<p>Base32 es un método de codificación que utiliza caracteres ASCII imprimibles.</p>
<p>En Base32, los datos se dividen en grupos de 5 bits, que se convierten en caracteres alfanuméricos (A-Z, 2-7). Se convierten cada 8 caracteres, y si el final tiene menos de 8 caracteres, se rellena con el signo igual (=).</p>

<p>La tabla de conversión a caracteres Base32 es la siguiente:</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>Datos de 5 bits</th><th>Carácter Base32</th></tr>
