...
<p>10, 100, 1000은 각각 '일십', '일백', '일천'이 아니라 '십', '백', '천'과 같이 '일'을 생략하는 것이 일반적입니다. 단, 대자의 경우는 '일(壱)'을 명기하는 경우가 있습니다.</p>

<p>소수점 이하는 '・' 뒤에 자릿수 기수법으로 표현합니다.</p>

<p>상기 대자 중, 일본 법령에서는 '壱', '弐', '参', '拾'만이 정해져 있습니다.</p>

<p>대자에서는 '억'(10<sup>8</sup>) 이상의 자릿수는 정의되어 있지 않지만, DenCode에서는 통상 한자 숫자와 같은 자릿수 이름으로 나타냅니다.</p>
