...
%><h3>Sobre el Cifrado Vigenère</h3>
<p>El Cifrado Vigenère es un tipo de cifrado de sustitución que encripta reemplazando caracteres en un texto con otros caracteres.</p>
<p>La sustitución de caracteres se realiza utilizando una clave de cifrado y el siguiente cuadrado de Vigenère.</p>
...
<p>La fila superior es el texto plano antes del cifrado, la columna izquierda es la clave de cifrado, y el carácter donde se cruzan es el carácter después del cifrado. La clave de cifrado es una cadena de "A" a "Z".</p>
