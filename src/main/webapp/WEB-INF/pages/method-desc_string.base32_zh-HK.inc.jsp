...
%><h3>關於 Base32</h3>
<p>Base32 是使用可列印 ASCII 字元的編碼方式。</p>
<p>在 Base32 中，資料被每 5 個位元分為一組，並轉換為英數字 (A-Z, 2-7) 來表示。每 8 個字元轉換一次，如果最後不足 8 個字元，則用等號 (=) 填充。</p>

<p>Base32 字元轉換表如下。</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>5位元資料</th><th>Base32 字元</th></tr>
