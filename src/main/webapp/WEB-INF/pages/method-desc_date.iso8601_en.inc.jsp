...
<p>Separate seconds and milliseconds with a comma (,) or dot (.). In DenCode, it is separated by the standard comma (,), and if the millisecond is 000, the millisecond is omitted.</p>
