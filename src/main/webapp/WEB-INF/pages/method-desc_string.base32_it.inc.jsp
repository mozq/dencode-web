...
%><h3>Informazioni su Base32</h3>
<p>Base32 è uno schema di codifica che utilizza caratteri ASCII stampabili.</p>
<p>Base32 divide i dati in blocchi di 5 bit e li converte in caratteri alfanumerici (A-Z, 2-7). Converte ogni 8 caratteri e, se l'ultimo blocco è inferiore a 8 caratteri, riempie con il simbolo uguale (=).</p>

<p>La tabella di conversione dei caratteri Base32 è la seguente:</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>Dati a 5 bit</th><th>Carattere Base32</th></tr>
...
<p>Ad esempio, la conversione di "Hello!" in Base32 è la seguente.</p>

<p>1. Rappresentazione binaria.</p>

<pre>01001000 01100101 01101100 01101100 01101111 00100001  (Per US-ASCII / UTF-8)</pre>

<p>2. Dividi ogni 5 bit. Se meno di 5 bit, riempi con "0" alla fine.</p>

<pre>01001 00001 10010 10110 11000 11011 00011 01111 00100 00100</pre>

<p>3. Converti in caratteri usando la tabella di conversione. Converti ogni 8 caratteri; se meno di 8, riempi con "=" alla fine.</p>
