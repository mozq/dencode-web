...
%><h3>Sobre Base32</h3>
<p>Base32 é um método de codificação que utiliza caracteres ASCII imprimíveis.</p>
<p>No Base32, os dados são divididos em 5 bits cada e convertidos em caracteres alfanuméricos (A-Z, 2-7). A conversão é feita a cada 8 caracteres, e se o final for menor que 8 caracteres, é preenchido com o sinal de igual (=).</p>

<p>A tabela de conversão para caracteres Base32 é a seguinte:</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>Dados de 5 bits</th><th>Caractere Base32</th></tr>
...
<p>Por exemplo, converter "Hello!" em Base32 resulta no seguinte:</p>

<p>1. Converta para representação binária.</p>

<pre>01001000 01100101 01101100 01101100 01101111 00100001  (No caso de US-ASCII / UTF-8)</pre>

<p>2. Divida a cada 5 bits. Se for menor que 5 bits, preencha o final com "0".</p>

<pre>01001 00001 10010 10110 11000 11011 00011 01111 00100 00100</pre>

<p>3. Converta para caracteres usando a tabela de conversão. Converta a cada 8 caracteres, e se for menor que 8 caracteres, preencha o final com "=".</p>

<pre>JBSWY3DP EE======</pre>

<p>4. Conecte todos os caracteres para obter o resultado da conversão Base32.</p>
