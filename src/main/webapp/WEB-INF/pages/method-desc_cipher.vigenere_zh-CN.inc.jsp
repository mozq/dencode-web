...
%><h3>关于维吉尼亚密码 (Vigenere Cipher)</h3>
<p>维吉尼亚密码是一种通过替换文本中的字符来进行加密的替换密码。</p>
<p>字符的替换是通过加密密钥和以下的维吉尼亚方阵进行的。</p>
...
<p>最上面的一行是加密前的明文，左侧列是加密密钥，它们交叉处的字符就是加密后的密文。加密密钥是由“A”到“Z”组成的字符串。</p>

<p>例如，加密前的明文是“MESSAGE”，加密密钥是“SECRET”，加密如下。第一个字符是“M”，密钥是“S”，因此加密后的字符是“E”。</p>
...
<p>明文的每个字符使用一个加密密钥字符。如果密钥长度短于明文，则重复使用密钥。</p>
